...
interface LotteryMissionCoinRepository : JpaRepository<LotteryMissionCoin, Long> {
    @Query(
        ...
        SELECT
            SUM(CASE 
                WHEN lmc.amountType = com.example.lottery.domain.lotteryMission.entity.LotteryMissionCoin.AmountType.PLUS 
                THEN lmc.amount 
                ELSE 0 
                END)
            - 
            SUM(CASE 
                WHEN lmc.amountType = com.example.lottery.domain.lotteryMission.entity.LotteryMissionCoin.AmountType.MINUS 
                THEN lmc.amount 
                ELSE 0 
                END)
